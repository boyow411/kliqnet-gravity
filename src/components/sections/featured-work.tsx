                ...
                <RevealSection className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                    <div>
                        ...
                        <h2 className="text-3xl md:text-5xl font-bold text-white max-w-3xl">
                            Proof that the work goes beyond good-looking pages.
                        </h2>
                        <p className="text-gray-400 text-lg leading-relaxed mt-5 max-w-2xl">
                            A few examples of how Kliqnet turns messy ideas, weak funnels and manual workflows into polished systems people can actually use.
                        </p>
                    </div>
                    <Link
                        href="/projects"
